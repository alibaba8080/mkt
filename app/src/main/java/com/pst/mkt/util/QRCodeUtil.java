...
//
//    Bitmap logoBitmap = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.ic_payqr_logo); // 间接调用 BitmapFactory.decodeStream
//    Bitmap qrcode_bitmap = QRCodeUtil.createQRCodeBitmap(result.QRURL, bind.payQRCode.getWidth(), bind.payQRCode.getHeight(), "UTF-8",
//            "L", "1", Color.BLACK, Color.WHITE, logoBitmap, 0.2F, null);
//                    bind.payQRCode.setImageBitmap(qrcode_bitmap);
    /**
